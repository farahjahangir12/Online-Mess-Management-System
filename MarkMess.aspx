<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MarkMess.aspx.vb" Inherits="MarkMess" %>
...
<body>
    ...
    <div class="nav-left">
     ...
     <div>
         ...
         <asp:Button ID="Show" runat="server" Text="Show Items" CssClass="button"  Width="50%"/><br />
       </div>
         ...
         <asp:Button ID="Confirm" runat="server" Text="Confirm" CssClass="button" Width="50%"/><br />
             </asp:Panel>
