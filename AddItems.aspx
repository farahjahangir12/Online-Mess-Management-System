<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddItems.aspx.vb" Inherits="AddItems" %>
...
<body>
 ...
 <asp:TextBox ID="ServingTextBox" runat="server" CssClass="textbox"></asp:TextBox><br />
